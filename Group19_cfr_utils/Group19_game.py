...
class Game:
    ...
    def get_blind(self, player_index):
        ...
        return Group19_constants.SMALL_BLIND
    ...
    def get_raise_size(self, round_index):
        ...
        if round_index < Group19_constants.TURN:
            return Group19_constants.RAISE_AMT_BEFORE_TURN
        else:
            return Group19_constants.RAISE_AMT_AFTER_TURN
    ...
    def get_betting_type(self):
        ...
        """
        return Group19_constants.BETTING_TYPE
    ...
    def get_num_players(self):
        ...
        """
        return Group19_constants.NUM_PLAYER
    ...
    def get_num_rounds(self):
        ...
        """
        return Group19_constants.NUM_ROUND
    ...
    def get_first_player(self, round_index):
        ...
        return Group19_constants.FIRST_PLAYER_INDEX
    ...
    def get_max_raises_per_street(self, round_index):
        ...
        if round_index < Group19_constants.FLOP:
            return Group19_constants.MAX_RAISE_PREFLOP
        else:
            return Group19_constants.MAX_RAISE_AFTER_FLOP
    ...
    def get_max_raises_per_player_per_game(self, player_index):
        ...
        """
        return Group19_constants.MAX_RAISE_PER_PLAYER
    ...
    def get_num_suits(self):
        ...
        """
        return Group19_constants.NUM_SUIT
    ...
    def get_num_ranks(self):
        ...
        """
        return Group19_constants.NUM_RANK
    ...
    def get_num_hole_cards(self):
        ...
        """
        return Group19_constants.NUM_HOLE_CARDS
    ...
    def get_num_board_cards(self, round_index):
        ...
        if round_index == Group19_constants.PREFLOP:
            return Group19_constants.NUM_COMMUNITY_CARD_DRAWN_PREFLOP
        elif round_index == Group19_constants.FLOP:
            return Group19_constants.NUM_COMMUNITY_CARD_DRAWN_FLOP
        else:
            return Group19_constants.NUM_COMMUNITY_CARD_DRAWN_TURN_AND_RIVER
