...
from Group19_evaluator import Evaluator as DeucesEvaluator
from Group19_card import Card as DeucesCard
...
def get_bucket_number(hole_cards, community_cards = None):
	...
	if not community_cards:
		...
		bucket_number = int(math.ceil((points + 1.5) / 21.5 * Group19_constants.BUCKET_NUM) - 1)
	else:
		...
		bucket_number = int(math.ceil(strength * Group19_constants.BUCKET_NUM) - 1)
